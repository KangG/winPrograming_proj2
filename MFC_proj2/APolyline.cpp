...
{
	dc->MoveTo(this->poly_array[this->index-1].getStart_x(),
		this->poly_array[this->index-1].getStart_y());
	dc->LineTo(this->poly_array[this->index-1].getEnd_x(),
		this->poly_array[this->index-1].getEnd_y());
}